...
- If youe added new route, youe will be add command  composer dump-autoload


#### Use Ajax to send forms' data:
Consider a route for your form like `/task/create`; now use `task-create` as an ID for form, and `task-create-submit` for submit button ID. All form's buttons need to have constant `form-button` class.

------------

Contact me: [artakkspoyan111290@gmai.com](artakkspoyan111290@gmai.com "artakkspoyan111290@gmai.com")
"# PHP-MVC-Framework" 
"# my_mvc" 
